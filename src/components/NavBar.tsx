...
type NavBarProps = NavBarContents & {
...
export default function NavBar({ links, tipoSelecionado, setTipoSelecionado, praiasSelecionadas, setPraiasSelecionadas }: NavBarProps) {
